<template>
    ...
    <v-container>
        <h1 class="title mt-5" data-aos="fade-up" data-aos-duration="3000">
            Welcome to <span class="highlight">Beliatta College</span>
        </h1>
        <br />
            ...
            <v-col cols="12" class="branch-card mt-3" style="text-align: center;">
                <div class="branch-info">
                    <p>
                        ...
                        Opposite Bus Stand, No 50 Tangalle Rd, Beliatta 82400
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <a href="tel:047 22 52 17 5">+94 47 225 2175</a> 
                    </p>
                    <!-- <p>
    ...
    export default {
        ...
        methods: {
            openGoogleMaps() {
                window.open('https://maps.app.goo.gl/xjkbDzPPT4pHZkaQ8?g_st=iw', '_blank');
            },
        },
    };
    </script>

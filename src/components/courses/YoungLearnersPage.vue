<template>
  <div>
    <NavBar></NavBar>
    <div class="container">
        <h1 class="title" data-aos="fade-up" data-aos-duration="3000"><span class="highlight">YOUNG LEARNERS</span></h1>
        <br>
        <h1 class="title" data-aos="fade-up" data-aos-duration="3000">Course Overview</h1>
        <br>
        ...
        <h1 class="title" data-aos="fade-up" data-aos-duration="3000">Learning Outcomes</h1>
        <br>
        <div class="center-container">
            <div class="content-row reverse">
                ...
                <div class="content-col image-col">
                    <img 
                        data-aos="zoom-out" 
                        data-aos-duration="2000" 
                        src="https://ik.imagekit.io/u3wbiya66/2024_11_07_15_33_IMG_8396.jpg?updatedAt=1737709328196" 
                        alt="Young Learners Activities" 
                        class="content-image"
                    />
                </div>
            </div>
        ...
        <div class="skills-grid">
            <div class="skill-card" data-aos="fade-right" data-aos-duration="3000">
                <div class="skill-header">
                    <span class="skill-icon">📖</span>
                    <h3 class="skill-title">Reading</h3>
                    <span class="skill-check">✓</span>
                </div>
                <div class="skill-content">
                    Starting with recognizing simple words and phrases, children will progress towards reading and understanding full sentences and stories with confidence.
                </div>
            </div>
            ...
            <div class="skill-card" data-aos="fade-right" data-aos-duration="3000">
                <div class="skill-header">
                    ...
                    <h3 class="skill-title">Writing</h3>
                    <span class="skill-check">✓</span>
                </div>
                <div class="skill-content">
                    Starting with writing and spelling simple words, children will then progress to learning how to write short stories.
                </div>
            </div>
            
            <div class="skill-card" data-aos="fade-left" data-aos-duration="3000">
                <div class="skill-header">
                    <span class="skill-icon">🔊</span>
                    <h3 class="skill-title">Listening</h3>
                    <span class="skill-check">✓</span>
                </div>
                <div class="skill-content">
                    Starting with listening to short conversations, children will progress to being able to understand simple English stories.
                </div>
            </div>
            ...
            <div class="skill-card" data-aos="fade-left" data-aos-duration="3000">
                <div class="skill-header">
                    <span class="skill-icon">💬</span>
                    <h3 class="skill-title">Speaking</h3>
                    <span class="skill-check">✓</span>
                </div>
                <div class="skill-content">
        ...
        <section class="why-choose-us" style="background-color: white !important;">
            <h2 class="title" style="color: #FBB700" data-aos="fade-up" data-aos-duration="3000">Course Details</h2>
                ...
                <div class="stats-row">
                    ...
                    <div class="stats-col">
                        <div class="custom-card age-card" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                            <div class="card-content">
                                <!-- Age animation section -->
                                <div class="age-interactive">
                                    <div class="age-circle age-circle-6">
                                        <span>6</span>
                                        <div class="circle-ring"></div>
                                    </div>
                                    <div class="age-connector">
                                    ...
                                    <div class="age-circle age-circle-12">
                                        <span>12</span>
                                        <div class="circle-ring"></div>
                                    </div>
                                </div>
        ...
        <h1 class="title" data-aos="fade-up" data-aos-duration="3000">Programme Levels</h1>
        <br>
        <div class="center-container">
        ...
        <h1 class="title" data-aos="fade-up" data-aos-duration="3000">Young Learners English (YLE) Exams</h1>
        <br>
        <div class="center-container">
            <div class="content-row">
                <div class="content-col image-col">
...
.age-card:hover .age-interactive {
    animation: bounceAge 0.5s ease;
}
...
.age-circle:hover {
    ...
    box-shadow: 0 0 15px rgba(255, 95, 21, 0.5);
}
...
.timeline::before {
    ...
    bottom: 0;
    width: 2px;
    background: linear-gradient(to bottom, #FF5722, #4CAF50);
}
